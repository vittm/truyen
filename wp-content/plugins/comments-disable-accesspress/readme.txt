...
== Changelog ==
= 1.0.5 = 
* WordPress 5.0 compatible check
* Updated backend Header color and Layout
...
= 1.0.3 = 
* Updated plugin's text domain to match plugin's slug
* Checked header sent before using session_start
