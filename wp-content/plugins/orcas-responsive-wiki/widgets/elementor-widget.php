 ...
 * @since 1.0.0
 */
class orcas_responsive_wiki extends Widget_Base {
    ...
    public function get_title() {
        return __( 'orcas Responsive Wiki', 'orcas-responsive-wiki' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_shortcode',
            [
                'label' => __( 'Shortcode', 'orcas-responsive-wiki' ),
            ]
        );
